...
public class PeopleService {
	...
	Database dbobj = MainService.getDBObject();
	...
	public void insertPeopleDataToDatabase(String aadhar,People people) {
		dbobj.addPeopledata(aadhar, people);
	}
	
	public List<People> getPeopleDataFromDatabase() {
		return dbobj.getPeopledata();
	}
	
	public People findPeopleInDatabase(String aadhar) {
		return dbobj.findPeople(aadhar);
	}
	
	public void insertAddressToDatabase(People people,List<Address> addresses) {
		dbobj.addAddress(people, addresses);
	}
}
